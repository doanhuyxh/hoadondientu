...
<div class="container d-flex justify-content-center mt-5">
    <div class="form-group w-75 shadow-lg p-3 mb-5 bg-body rounded">
        <table class="table">
            <tr>
                <th>Mã số thuế</th>
                <td><?php echo $data['user']->tax_code; ?></td>
            </tr>
            <tr>
                <th>Tên đăng nhập</th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="form-group">
                        <h5>Tỷ giá</h5>
                        <div class="form-check">
                            <input id="listExchangeRate" value="listExchangeRate" class="form-check-input" type="checkbox">
                        ...
                        <div class="form-check">
                            <input id="deleteExchangeRate" value="deleteExchangeRate" class="form-check-input" type="checkbox">
